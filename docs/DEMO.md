...
- a `DONE` badge and the pass count — **108/108 checks · 17/17 workflows** on run
  `20260729-013852-1df3`, the last full sweep recorded in `backend/data/qa/`;
...
Observed on that run: 108/108 checks, 17/17 flows, no console
